            ...
            <div class="row justify-content-center">
                    ...
                    <div class="single-tranding">
                        <a href="index.php?page=product-details">
                            <div class="tranding-pro-img">
                                <img src="public/assets/store/assets/img/product/tranding-1.jpg" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-tranding">
                        <a href="product-details.html">
                            <div class="tranding-pro-img">
                                <img src="public/assets/store/assets/img/product/tranding-2.jpg" alt="">
                            </div>
                            <div class="tranding-pro-title">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    <div class="single-tranding">
                        <a href="product-details.html">
                            <div class="tranding-pro-img">
                                <img src="public/assets/store/assets/img/product/tranding-3.jpg" alt="">
                            </div>
                            <div class="tranding-pro-title">
