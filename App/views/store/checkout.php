            ...
            <div class="col-12">
                <div class="user-actions">
                    <h3>
                        ...
                        Returning customer?
                        <a class="Returning" href="<?= BASE_URL ?>login" data-toggle="collapse" data-target="#checkout_login" aria-expanded="true" aria-controls="checkout_login">Click here to login</a>

                    </h3>
                    <div id="checkout_login" class="collapse" data-parent="#accordionExample">
                        <div class="checkout_info">
                            <p>If you have shopped with us before, please enter your details in the boxes below. If you are a new customer please proceed to the Billing & Shipping section.</p>
                            <form action="<?= BASE_URL ?>order">
                    ...
                    <form action="<?= BASE_URL ?>order" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-20">
                                ...
                                <input type="text" name='fname' value="<?= $user['name'] ?>" disabled>
                            </div>
                            <div class="col-lg-6 mb-20">
                            ...
                            <div class="col-12 mb-20">
                                <input id="account" type="checkbox" data-target="create_account" />
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($cart_items as $cart_item):  ?>
                                            <tr>
                                                <td> <?= $cart_item->getProduct()->getName() ?> <strong> × <?= $cart_item->getQty() ?></strong></td>
                                                <td> $ <?= $cart_item->getSubTotal() ?></td>
                                            </tr>
                                        <?php $total += $cart_item->getSubTotal();
                                        endforeach; ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
