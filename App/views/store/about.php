                ...
                <div class="col-12">
                   <figure>
                        <div class="about_thumb">
                            <img src="assets/store/assets/img/about/about1.jpg" alt="">
                        </div>
            ...
            <div class="row">
                    ...
                    <article class="single_gallery_section">
                        <figure>
                            <div class="gallery_thumb">
                                <img src="<?= BASE_URL ?>assets/store/assets/img/about/about2.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <article class="single_gallery_section">
                        <figure>
                            <div class="gallery_thumb">
                                <img src="assets/store/assets/img/about/about3.jpg" alt="">
                            </div>
                            <figcaption class="about_gallery_content">
                               <h3>History Of Us</h3>
                                <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="assets/store/assets/img/about/About_icon1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="assets/store/assets/img/about/About_icon2.png" alt="">
                        </div>
                        <div class="chose_content">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="single_chose">
                        <div class="chose_icone">
                            <img src="assets/store/assets/img/about/About_icon3.png" alt="">
                        </div>
                        <div class="chose_content">
                            <h3>High Quality</h3>
                            <p>Erat metus sodales eget dolor consectetuer, porta ut purus at et alias, nulla ornare velit amet</p>
           ...
           <div class="row justify-content-center">
                    ...
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="assets/store/assets/img/about/team-1.jpg" alt="">
                            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="assets/store/assets/img/about/team-2.jpg" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>Mary Marlive</h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="assets/store/assets/img/about/team-3.jpg" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>Michael Corn</h3>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <article class="team_member">
                        <figure>
                            <div class="team_thumb">
                                <img src="assets/store/assets/img/about/team-4.jpg" alt="">
                            </div>
                            <figcaption class="team_content">
                                <h3>James Troops</h3>
