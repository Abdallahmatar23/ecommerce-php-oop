                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widgets_container contact_us">
                        <div class="footer_logo">
                            <a href="#"><img src="public/assets/store/assets/img/logo/logo.png" alt=""></a>
                        </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <a href="#"><img src="public/assets/store/assets/img/icon/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Plugins JS -->
<script src="public/assets/store/assets/js/plugins.js"></script>

<!-- Main JS -->
<script src="public/assets/store/assets/js/main.js"></script>
